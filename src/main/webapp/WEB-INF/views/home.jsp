        ...
        <div class="item active">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Welcome to Spring Music Store.</h1>
                    <p>Here you can browse and buy Instruments, records and music related Accessories. Order for
        ...
        <div class="item">
            ...
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <p>Through ups and downs, Seehow I manage to survive in life.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            <a class="btn btn-default btn-circle" href="<c:url value="/product/productList?searchCondition=Instrument" />"
            role="button">
                <img class="img-circle" src="<c:url value="/resources/images/instrument.jpg" />"
                     alt="Instrument Image" width="140" height="140"/></a>
            <h2>Instrument</h2>
        ...
        <div class="col-lg-4">
            <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Record" />"
               role="button">
                <img class="img-circle" src="<c:url value="/resources/images/record.jpg" />"
        ...
        <div class="col-lg-4">
            <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Accessory" />"
               role="button">
                <img class="img-circle" src="<c:url value="/resources/images/showroom.jpg" />"
